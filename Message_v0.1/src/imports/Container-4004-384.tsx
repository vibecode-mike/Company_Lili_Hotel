...
function TemplateText1ActionButton() {
  return (
    <div className="bg-[#f6f9fd] relative rounded-[15px] shrink-0 w-[288px]" data-name="Template#Text＋1 Action Button">
