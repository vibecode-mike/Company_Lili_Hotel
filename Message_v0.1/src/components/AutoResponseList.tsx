...
export default function AutoResponseList({ onBack }: AutoResponseListProps) {
          ...
          <div className="bg-white relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-full border-b border-[#dddddd] min-w-[1400px]">
            <div className="flex flex-row items-center size-full">
              <div className="box-border content-stretch flex items-center pb-[12px] pt-[16px] px-[12px] relative w-full">
                <div className="box-border content-stretch flex gap-[4px] items-center px-[12px] py-0 relative shrink-0 w-[320px]">
                ...
                <div className="box-border content-stretch flex gap-[4px] items-center px-[12px] py-0 relative shrink-0 w-[192px]">
                  <div className="basis-0 flex flex-col font-['Noto_Sans_TC:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#383838] text-[14px]">
                ...
                <div className="box-border content-stretch flex gap-[4px] items-center px-[12px] py-0 relative shrink-0 w-[280px]">
                ...
                <div className="box-border content-stretch flex gap-[4px] items-center px-[12px] py-0 relative shrink-0 w-[140px]">
                  <div className="flex flex-col font-['Noto_Sans_TC:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#383838] text-[14px] text-nowrap">
            ...
            <div key={response.id} className="bg-white relative shrink-0 w-full border-b border-[#dddddd] last:border-b-0 min-w-[1400px]">
              <div className="flex flex-row items-center size-full">
                <div className="box-border content-stretch flex items-center p-[12px] relative w-full">
                  {/* Content */}
                  <div className="content-stretch flex items-center relative shrink-0 w-[320px]">
                    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
                      <div className="flex flex-row items-center size-full">
                  ...
                  <div className="content-stretch flex items-center relative shrink-0 w-[192px]">
                    <div className="box-border content-stretch flex items-center px-[12px] py-0 relative shrink-0 w-[278.8px]">
                      <div className="basis-0 flex flex-col font-['Noto_Sans_TC:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#383838] text-[14px]">
                  ...
                  {/* Keywords */}
                  <div className="box-border content-center flex flex-wrap gap-[4px] items-center px-[12px] py-0 relative shrink-0 w-[280px]">
                    {response.keywords.length > 0 ? (
                      response.keywords.map((keyword, idx) => (
                        <div key={idx} className="bg-[#f0f6ff] box-border content-stretch flex gap-[2px] items-center justify-center min-w-[32px] p-[4px] relative rounded-[8px] shrink-0">
                          <p className="basis-0 font-['Noto_Sans_TC:Regular',sans-serif] font-normal grow leading-[1.5] min-h-px min-w-px relative shrink-0 text-[#0f6beb] text-[16px] text-center">{keyword}</p>
                        </div>
                      ))
                    ) : (
                      <div className="basis-0 flex flex-col font-['Noto_Sans_TC:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#383838] text-[14px]">
