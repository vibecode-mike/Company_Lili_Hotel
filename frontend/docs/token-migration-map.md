...
| `rounded-[80px]` | 4 | `rounded-full` | ⚠️ 膠囊 / 圓 | MessageList×2、AIChatbotOverview×2 |
...
- `rounded-[32px]`（SecondaryButton）/ `rounded-[80px]`（MessageList、AIChatbotOverview）→ 建議 `rounded-full`
