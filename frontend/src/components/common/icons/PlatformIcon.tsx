...
// 與 Sidebar.tsx「自動回應」小標題使用同一顆機器人 SVG path
const WEBCHAT_ROBOT_PATH =
...
/**
 * WebChat 圖標
 * 與 Sidebar 自動回應小標題同一顆機器人 SVG，fill 採用 #6E6E6E
 */
function WebChatRobotSvg({ size }: { size: number }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d={WEBCHAT_ROBOT_PATH} fill="#6E6E6E" />
    </svg>
  );
}
