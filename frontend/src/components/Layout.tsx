    ...
    <div className="bg-slate-50 min-h-screen flex">
      ...
      <aside className={`bg-slate-100 content-stretch flex flex-col h-screen items-start fixed top-0 left-0 shrink-0 z-50 ${sidebarOpen ? 'w-[330px] lg:w-[280px] md:w-[250px]' : 'w-[72px]'} transition-all duration-300`}>
        ...
        <div className="box-border flex items-center justify-between p-4 w-full">
          {sidebarOpen && (
            <div className="content-stretch flex flex-col h-[56px] items-start justify-center overflow-visible relative shrink-0 w-[148px]">
              <StarbitLogo />
            </div>
          )}
          <button
          ...
          {sidebarOpen && (
            <>
              ...
              <div className="box-border flex flex-col gap-1 px-4">
                ...
                >
                  <p className={`text-[16px] ${
                    activeSection === 'messages' ? 'text-[#0f6beb]' : 'text-[#383838]'
                  }`}>活動與訊息推播</p>
                </button>
                <button
                  type="button"
                ...
                >
                  <p className={`text-[16px] ${
                    activeSection === 'autoResponse' ? 'text-[#0f6beb]' : 'text-[#383838]'
                  }`}>自動回應</p>
                </button>
              </div>
              ...
              <div className="box-border flex flex-col gap-1 px-4 mt-5">
                ...
                >
                  <p className={`text-[16px] ${
                    activeSection === 'members' ? 'text-[#0f6beb]' : 'text-[#383838]'
                  }`}>會員管理</p>
                </button>
              </div>
              ...
              <div className="box-border flex flex-col gap-1 px-4 mt-5">
                ...
                >
                  <p className={`text-[16px] ${
                    activeSection === 'tags' ? 'text-[#0f6beb]' : 'text-[#383838]'
                  }`}>標籤管理</p>
                </button>
              </div>
            </>
      ...
      {/* Main Content */}
      <main className={`flex-1 h-screen overflow-auto bg-slate-50 transition-all duration-300 ${sidebarOpen ? 'ml-[330px] lg:ml-[280px] md:ml-[250px]' : 'ml-[72px]'}`}>
        {children}
      </main>
    </div>
  );
