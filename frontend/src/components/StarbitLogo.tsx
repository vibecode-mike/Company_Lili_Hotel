...
export default function StarbitLogo({ onClick }: StarbitLogoProps) {
  return (
    <div className={`h-[49.333px] overflow-clip relative shrink-0 w-[148px] ${onClick ? 'cursor-pointer hover:opacity-80 transition-opacity' : ''}`} onClick={onClick}>
