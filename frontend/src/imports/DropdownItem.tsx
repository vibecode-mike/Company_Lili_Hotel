import svgPaths from "./svg-nzneb56q8o";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      <p className="basis-0 font-['Noto_Sans_TC:Regular',_sans-serif] font-normal grow leading-[1.5] min-h-px min-w-px relative shrink-0 text-[#a8a8a8] text-[16px]">點擊 Enter 即可新增互動標籤</p>
    </div>
  );
}
...
function DropdownItem1() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[558px]" data-name="Dropdown Item">
      <TextArea />
      <DropdownItem />
    </div>
  );
