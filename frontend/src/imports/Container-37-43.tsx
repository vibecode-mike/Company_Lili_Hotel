function Paragraph({ title }: { title?: string }) {
  return (
    <div className="absolute h-[28.5px] left-[16px] overflow-clip top-[336px] w-[256px]" data-name="Paragraph">
...
function Paragraph1({ content }: { content?: string }) {
  return (
    <div className="absolute h-[18px] left-[16px] overflow-clip top-[380.5px] w-[256px]" data-name="Paragraph">
...
function Paragraph2({ price, currency }: { price?: string; currency?: string }) {
  return (
    <div className="absolute h-[36px] left-[16px] top-[414.5px] w-[256px]" data-name="Paragraph">
...
function Container2({ button1, button2 }: { button1?: string; button2?: string }) {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[5px] h-[122px] items-start left-0 pb-0 pl-[16px] pr-0 pt-[7px] top-[466.5px] w-[288px]" data-name="Container">
...
function Paragraph5({ imageUrl }: { imageUrl?: string }) {
  ...
  return (
    <div className="absolute h-[28.5px] left-[106px] top-[145.75px] w-[76px]" data-name="Paragraph">
...
function Container3({ imageUrl }: { imageUrl?: string }) {
  return (
    <div className="absolute bg-[#edf0f8] h-[320px] left-0 overflow-clip top-0 w-[288px]" data-name="Container">
...
function Container4({ cardData }: { cardData?: any }) {
  return (
    <div className="bg-white h-[588.5px] relative rounded-[12px] shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[588.5px] overflow-clip relative rounded-[inherit] w-full">
