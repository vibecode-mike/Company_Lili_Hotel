...
function Digit() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Digit">
      <div className="absolute bottom-0 flex flex-col font-['Noto_Sans_TC:Regular',_sans-serif] font-normal justify-center leading-[0] left-[95.33%] right-0 text-[#6e6e6e] text-[12px] text-nowrap text-right top-0">
