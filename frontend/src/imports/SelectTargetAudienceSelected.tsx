import svgPaths from "./svg-ilr6rt97pd";
...
export default function SelectTargetAudienceSelected() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative size-full" data-name="Select#Target Audience#Selected">
      <RadioButton1 />
      <TextArea />
    </div>
  );
